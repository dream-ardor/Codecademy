...
**Instructions:**
Require the error handling package that you found. Replace your catch-all error handler with the middleware created by the error handler package. You can use the default settings.
